...
subtitle: "R packages to query BlueSky posts and interact with your choice of LLM"
format:
  lumo-html: 
    logo: "profile-pic-removebg-preview.png"       # Optional. Path to a logo displayed above the title
    github-repo: "https://github.com/madison-merzke" # Optional. Adds a github corner at the top right
    primary-color: "black"
    self-contained: true
    bg-image: "blue_sky.jpg"          # Optional: link to an image for the header background
...
-   `bskyr` for interacting with the BlueSky API and

-   `ellmer` from the tidyverse for interacting with LLMs.
...
1.  Downloading and installing the [Ollama](https://ollama.com/) software, which allows you to run open-source LLMs locally - on your own computer! Thus, this is free, does not require account setup, and keeps your data on your own machine, which is more private.
